if __name__ == '__main__':
    ...
    def write_channel_voltage(channel:int, voltage:float, v_max=5):
        """
        ...
        ao.DACDirect(ao.diOnly, channel, short_out)
    ...
    for t in tqdm(np.arange(0,10,dt)):
        ...
        write_channel_voltage(0, x)
        write_channel_voltage(1, y)
        time.sleep(dt)
    write_channel_voltage(0, 0)
    write_channel_voltage(1, 0)
